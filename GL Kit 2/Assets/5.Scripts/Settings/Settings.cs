...
public static class Settings
{
	...
	public const float VAL_CAMERA_MINOR_ZOOM_DISTANCE             = 250.0f;
	
	public const float VAL_CAMERA_MOVEMENT_SPEED                  = 0.1f;
	//public const float VAL_CAMERA_TRANSITION_SECONDS              = 0.25f;
	public const float VAL_CAMERA_TRANSITION_SECONDS              = 4.0f;
	...
	public const int VAL_CHARACTERS_PER_SPEECH_BUBBLE             = 140;
