...
public static class LoadingPaths
{
	...
	public const string FILE_NAME_WEARABLES = "WEARABLES";
	public const string FILE_NAME_TABLETOP = "TABLETOP";
	public const string FILE_NAME_VR = "VR";
	public const string FILE_NAME_PC = "PC";
	public const string FILE_NAME_CONSOLE = "CONSOLE";
